...
<section id="Area"><form id="formld">
 <div id="div1" class="class 1">
  <label id="id11" class="class1">
  <% String sName = request.getParameter("sName");
  out.println("<input id='id 12' class='calss3' type='text' name='sName' size='20' maxlength='50' value="' +
  sName +"'>");%></div>
  <div id="div2" class="class1">
    <label id="id21" calss="class2"for="id22">학번</label>
